...
def abrir_tela_cadastro(janela, conexao, fonte, usuario_var, senha_var):
    # Criando uma nova janela para o cadastro
    janela_cadastro = Toplevel(janela)
    janela_cadastro.title("Cadastro")

    # Definindo os rótulos e entradas de texto
    ...
    cadastrar_button = Button(janela_cadastro, text="Cadastrar", command=lambda: cadastrar_e_notificar_usuario(conexao, usuario_cadastro_var, senha_cadastro_var, janela_cadastro, fonte), font=fonte)
    cadastrar_button.grid(columnspan=2)
